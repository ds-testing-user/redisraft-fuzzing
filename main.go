		...
		Run: func(cmd *cobra.Command, args []string) {
			fConfig := FuzzerConfig{
				...
				ClusterConfig: &ClusterConfig{
					NumNodes:              nodes,
					RaftModulePath:        "/Fuzzing/redisraft-fuzzing/redisraft.so",
					RedisServerBinaryPath: "/Fuzzing/redis/src/redis-server",
				},
			}
			...
			c.AddBenchmark("line", NewLineCovGuider("/Fuzzing/redisraft-fuzzing/build/deps/raft/CMakeFiles/raft.dir/src", "127.0.0.1:2023", path.Join(savePath, "line_traces")), mutator)
